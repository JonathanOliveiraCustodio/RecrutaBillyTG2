...
<body>
    <div class="container py-4">
        ...
        <p class="lead text-center">Desculpe, o acesso ao recurso solicitado requer pagamento.</p>
        <p class="text-center">Por favor, complete o pagamento para continuar. Se você já pagou, verifique o status da sua transação ou entre em contato com o suporte.</p>
        ...
        <div class="container">
            <!-- Adicione informações adicionais sobre como proceder para o pagamento, se necessário -->
        </div>
    </div>
