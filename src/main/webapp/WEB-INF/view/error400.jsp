...
<body>
	...
	<div class="container py-4">
		...
		<p class="lead text-center">Desculpe, a solicitação que você
			enviou é inválida ou malformada.</p>
		<p class="text-center">Verifique os dados que você enviou e tente
			novamente. Se você continuar encontrando problemas, entre em contato
			com o suporte.</p>
		<p class="text-center">
			Você pode voltar para a <a
				href="${pageContext.request.contextPath}/index">página inicial</a>
			ou visitar a nossa <a
				href="${pageContext.request.contextPath}/support">página de
				suporte</a>.
		</p>
