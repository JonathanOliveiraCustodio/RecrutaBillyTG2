			...
			<div class="container-fluid py-1">
				...
				<form id="configuracoes" action="configuracoes" method="post"
					...
					<div class="col-md-6 form-floating">
						...
						<label for="maxOrcamentos">Quantidade Máxima de Orçamentos
							em Aberto</label>
					</div>
					...
					<div class="col-md-6 form-floating">
						<input type="number" class="form-control" id="medPedidosAndamento"
							name="medPedidosAndamento"
							value="${configuracoes.qtdMediaPedidoAndamento}"
							placeholder="Quantidade Média de Pedidos em Andamento"> <label
							for="medPedidosAndamento">Quantidade Média de Pedidos em
							Andamento</label>
					</div>

					<div class="col-md-6 form-floating">
						<input type="number" class="form-control" id="medPedidosRecebidos"
							name="medPedidosRecebidos"
					...
					<div class="col-md-6 form-floating">
						<input type="number" class="form-control" id="medProducaoProdutos"
							name="medProducaoProdutos"
							value="${configuracoes.qtdMediaProducaoProdutos}"
							placeholder="Quantidade Média de Produção de Produtos"> <label
							for="medProducaoProdutos">Quantidade Média de Produção de
							Produtos</label>
					</div>
