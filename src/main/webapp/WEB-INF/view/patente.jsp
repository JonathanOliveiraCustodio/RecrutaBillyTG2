...
<body>
	<script
		src="${pageContext.request.contextPath}/resources/js/patente.js"></script>
	<script
		...
		<c:if test="${nivelAcesso == 'admin'}">
			<div class="p-5 mb-4 bg-body-tertiary rounded-3 text-center shadow">
				<div class="container-fluid py-1">
					<h1 class="display-6 fw-bold">Manutenção de Patentes</h1>
					...
					<form action="patente" method="post" class="row g-3 mt-3"
							...
							<div class="col-md-4">
								<div class="form-floating">
									<input type="number" min="0" step="1" id="codigo" name="codigo"
										...
										value='<c:out value="${patente.codigo }"></c:out>' readonly>
							...
							<div class="col-md-3">
								<div class="form-floating">
									<input type="text" id="nome" name="nome" class="form-control"
										...
										value='<c:out value="${patente.nome }"></c:out>'> <label
										for="nome">Nome</label>
								</div>
							</div>
							<div class="col-md-1">
							...
							<div class="col-md-4">
								<div class="form-floating">
									<input type="text" id="instituicao" name="instituicao" class="form-control"
										placeholder="Instituição" maxlength="150"
										value='<c:out value="${patente.instituicao }"></c:out>'> <label
	...
	<div class="container py-4 text-center d-flex justify-content-center"
		align="center">
		<c:if test="${nivelAcesso == 'admin' && not empty patentes}">
			<div class="table-responsive w-100">
				<table class="table table-striped">
					<thead>
						<tr>
							<th class="titulo-tabela" colspan="5"
								style="text-align: center; font-size: 35px;">Lista de Patentes
						<tr class="table-dark">
							<td></td>
							<td>Código</td>
							<td>Nome</td>
					...
					<tbody class="table-group-divider">
							...
							<tr>
								<td style="text-align: center;">
									<button class="btn btn-outline-dark" name="opcao"
										value="${p.codigo}" onclick="editarPatente(this.value)"
						...
						<path fill-rule="evenodd"
								...
								<td><c:out value="${p.instituicao }" /></td>
								<td style="text-align: center;">
									<button class="btn btn-danger"
										onclick="excluirPatente('${p.codigo}')">Excluir</button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
