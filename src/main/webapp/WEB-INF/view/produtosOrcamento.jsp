...
<script src="${pageContext.request.contextPath}/resources/js/produtosOrcamento.js"></script>
	...
	<div class="container py-4">
		<div class="p-5 mb-4 bg-body-tertiary rounded-3 text-center shadow">
			<div class="container-fluid py-1">
				...
				<form action="produtosOrcamento" method="post" onsubmit="return validarFormulario(event);" class="container mt-3">
							...
							<tr>
								...
								<td>
									<form action="produtosOrcamento" method="post"
										...
										<input type="hidden" name="pedido" value="${p.codigoOrcamento}">
