...
function editarPatente(codigo) {
    window.location.href = 'patente?cmd=alterar&codigo=' + codigo;
}

function excluirPatente(codigo) {
    if (confirm("Tem certeza que deseja excluir esta Patente?")) {
        window.location.href = 'patente?cmd=excluir&codigo=' + codigo;
    }
}
